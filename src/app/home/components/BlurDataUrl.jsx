...
export default function BlurData({blurDataURL,children}) {
  ...
  return (
    <div className=' flex justify-center flex-col items-center'>
       <H1 className=' text-purple-200 lg:text-5xl text-2xl select-none'>如对您有帮助,请<P className=' cursor-pointer text-red-400 transform ' onClick={()=> setShow((pre)=> !pre)}>支持</P> 下煮啵</H1>
       {children}
       {
          show &&
